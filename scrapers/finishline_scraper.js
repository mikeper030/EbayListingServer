...
const getDataFromUrl = async function (url) {
    ...
    try {
//         var  ip_addresses=require("../bin/www").ip_addresses;
//         var  port_numbers=require("../bin/www").port_numbers;
...
module.exports.newRequest = getDataFromUrl;
